...
def test_emcee():
    '-----------------------------read data--------------------------'
    mge2d, dist, xbin, ybin, rms, erms = np.load('data/mock_sgnfw_gas_data.npy')
    ...
    galaxy = {'lum2d': mge2d, 'distance': dist, 'xbin': xbin, 'ybin': ybin,
              ...
              'clip': 'noclip', 'outfolder': 'data', 'Mgas': 5.582e+09,
              'fname': 'mock_sgNFW_gas_out.dat'}
